...
<div class="container">
  <button class="button-pkp">New Record</button>
  <br><br>
  <button class="button-pkp">History Record</button>
</div>
<div class="footer">
  <p>Copyright &copy; 2018 SYSTEM MAINTAINANCE UITM INFOTECH </p>
</div>
