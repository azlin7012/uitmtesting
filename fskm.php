...
<div class=header href=style.css>
   ...
   <a href="login.php" class="button">Log Keluar</a>
    ...
    <div class="centered"><h2><strong>Fakulti Sains Komputer dan Matematik</strong></h2></div>
...
<div class="container">
  <a href="fskmnew.php"><button class="button-fskm" >New Record</button></a>
  <br><br>
  <a href="fskmrec.php"><button class="button-fskm">History Record</button></a>
</div>
<div class="footer">
